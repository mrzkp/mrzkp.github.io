/**
 * Math Quiz Component
 * A simple math quiz widget that generates random arithmetic problems
 */
class MathQuiz {
    ...
    createElements() {
        this.container.innerHTML = `
            <div class="quiz-row">
                ...
                <input type="number" class="math-input" id="${this.containerId}-answer" placeholder="" />
            </div>
        `;
        
        this.equationElement = document.getElementById(`${this.containerId}-equation`);
    ...
    // Public methods for controlling the quiz
    destroy() {
        if (this.container) {
